...
public static class ExtGameObject
    {
         ...
         public static void DeactivateUp( this GameObject go)
        {
         ...
         // go.DeactivateDown will deactivate all children                
        public static void DeactivateDown(this GameObject obj)
        {
          ...
          // go.ActivateUp will activate all ancestors                
        ...
        // go.ActivateDown will deactivate all children                
        ...
        public static string Status(this GameObject go)
        {
            string _s = 
                       ...
                       + " " + (go.activeSelf ? " SelfActive " : " SelfInActive ").ToString()
                       + "-" + (go.activeInHierarchy ? " HiActive" : " HiInActive ").ToString()
                                    + " ";
            return _s;
        }
